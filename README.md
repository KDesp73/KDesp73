...
[![My Skills](https://skillicons.dev/icons?i=c,java,py,html,css,js,php,arduino,git,linux,neovim,svelte,ruby,lua,sqlite,kotlin,androidstudio,firebase,go,bash,postgres,react,zig,typescript,laravel&perline=9)](https://skillicons.dev) 
